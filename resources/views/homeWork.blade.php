      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <ul class="logout-mode bg-white flex items-center justify-center space-x-6  md:ml-96">
            <li class="hover:bg-herbg rounded-md hover:text-ttC ml-4 md:ml-96 p-1 font-semibold text-g00"><a href="#">
    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
      <div class="dash-content mt-2 py-5   bg-white shadow-md  ">
        <div class="title space-y-3">
            ...
            <span class="inner-name text bg-slate-50 font-extrabold text-textHover m-3 my-14  p-3 rounded-md">Home Works</span>
        </div>
        
          <!--Homme work-->
          @foreach($works as $w)
          <div class="bg-white shadow-md rounded-b-md  border-gray-300 overflow-x-auto p-1 mt-5">
            <table class="table w-full">
                <tbody>
                  <tr class="taj">
                    <td class="p-2  border text-htext font-bold">Tittle</td>
                    <td class="p-2 text-textC font-normal border-2 ">{{$w->	title}}</td>
                </tr>
                    <tr class="taj">
                        <td class="p-2 border-2 text-htext font-bold">Description</td>
                        <td class="p-2 text-textC font-normal border-2 ">{{$w->description}}</td>
                    </tr>
                    
                    <tr class="taj">
                        <td class="p-2  border-2  text-htext font-bold">Assignment Date</td>
                        <td class="p-2 text-textC font-normal border-2 ">{{$w->date_of_homework}}</td>
                    </tr>
                    <tr class="taj">
                        <td class="p-2  border-2  text-htext font-bold">URL</td>
                        <td class="p-2 text-textC font-normal border-2 "><a href="{{$w->url}}"target='blank'class='text-white bg-blue-300 hover:bg-gray-400 p-2.5 rounded-md font-bold'>View</a></td>
                    </tr>
