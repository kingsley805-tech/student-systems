      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <ul class="logout-mode bg-white flex items-center justify-center space-x-6  md:ml-96">
            <li class="hoer:bg-hoverbg rounded-md hover:text-texC ml-4 md:ml-96 p-1 font-semibold text-gry-600"><a href="#">
    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
      <div class="dash-content mt-2 py-5   bg-white shadow-md  ">
        <div class="title space-y-3">
            ...
            <span class="inner-name text bg-slate-50 font-extrabold text-textHover m-3 my-10  p-3 rounded-md">Live Classes</span>
        </div>
       
        <!--live class-->

        <div class="live mt-9 "><div class="flex"><div class="w-8 h-8 md:w-10 md:h-10 bg-red-400 border-2 text-center  rounded-full border-red-400 font-black text-white text-xl md:text-2xl">!</div><span class="font-black text-gray-900 text-xl md:text-2xl ">There is no live class.</span></div>
