      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <ul class="logout-mode bg-white flex items-center justify-center space-x-6  md:ml-96">
            <li class="hover:b-hoverbg rounded-md hover:text-text ml-4 md:ml-96 p-1 font-semibold tex-gray-600"><a href="#">
    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
      <div class="dash-content mt-2 py-5   bg-white shadow-md  ">
        <div class="title space-y-3">
            ...
            <span class="inner-name  text bg-slate-50 font-extrabold text-textHover m-3 my-14  p-3 rounded-md">Books Issued</span>
        </div>
        ...
        <div class="  bg-white flex flex-col items-center justify-center m-auto pt-4">
            <table class="table border-collapse shadow-md border border-gray-300 w-full">
              <thead>
                <tr class=" text-white">
                  <th class="px-4 py-2 text-htext font-semibold">PROPERTY</th>
                  <th class="px-4 py-2 text-htext font-semibold">VALUE</th>
                </tr>
              </thead>
              <tbody>
                <tr class="taj bg-white border-t border-b">
                  <td class="px-4 py-2 text-htext font-semibold border-r text-center">BOOKS TITLE</td>
                  <td class="px-4 py-2 text-textC font-semibold text-center">{{$b->title}}</td>
                </tr>
                <tr class="taj bg-white border-t border-b">
                  <td class="px-4 py-2 text-htext font-semibold border-r text-center">QUANTITY</td>
                  <td class="px-4 py-2 text-textC font-semibold text-center">{{$b->quantity}}</td>
                </tr>
                <tr class="taj bg-white border-t border-b">
                  <td class="px-4 py-2 text-htext font-semibold border-r text-center">ISSUED DATE</td>
                  <td class="px-4 py-2 text-textC font-bold text-center">{{$b->dateIssued}}</td>
                </tr>
                <tr class="taj bg-white border-t border-b">
                  <td class="px-4 py-2 text-htext font-semibold border-r text-center">RETURN DATE</td>
                  <td class="px-4 py-2 text-textC font-semibold text-center">{{$b->returnDate}}</td>
                </tr>
                <tr class="taj bg-white border-t border-b">
                  <td class="px-4 py-2 text-htext font-semibold border-r text-center">RETURN STATUS</td>
                  <td class="px-4 py-2 text-hoverText font-semibold text-center">{{$b->returnDate}}</td>
                </tr>
                <tr class="taj bg-white border-t border-b">
                  <td class="px-4 py-2 text-htext font-semibold border-r text-center">AUTHOR</td>
                  <td class="px-4 py-2 text-textC font-semibold text-center">{{$b->author}}</td>
                </tr>
