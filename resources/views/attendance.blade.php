    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
      <div class="dash-content mt-2 py-5   bg-white shadow-md  ">
        <div class="title space-y-3">
            ...
            <span class="inner-name text bg-slate-50 font-extrabold text-textHover m-3 my-10  p-3 rounded-md">Attendance</span>
        </div>
   
        <!--attendance-->
        <div class="attends flex items-center justify-center">
          <div class="bg-white flex flex-col shadow-md p-4  md:w-1/2 lg:w-1/3===">
              <h2 class="text-xl md:text-2xl font-semibold text-center mb-4">Attendance Report</h2>
             
              <table class="w-full border border-gray-300 shadow-sm rounded-lg">
                  <thead class="bg-white ">
                      <tr>
                          <th class="py-2 px-2 md:px-4 border">student</th>
                          <th class="py-2 px-2 md:px-4 border">Index Number</th>
                          <th class="py-2 px-2 md:px-4 border">class Name</th>
                          <th class="py-2 px-2 md:px-4 border">WeeK</th>
                          <th class="py-2 px-2 md:px-4 border">Day</th>
                          <th class="py-2 px-2 md:px-4 border">Month</th>
                          <th class="py-2 px-2 md:px-4 border">Total Present</th>
                          <th class="py-2 px-2 md:px-4 border">Total Absent</th>
                      </tr>
                  </thead>
                  <tbody>
                      <tr class="bg-white">
                          <td class="py-2 px-2 md:px-4 border">Overall</td>
                          <td class="py-2 px-2 md:px-4 border">0</td>
                          <td class="py-2 px-2 md:px-4 border">0</td>
                          <td class="py-2 px-2 md:px-4 border">0</td>
                          <td class="py-2 px-2 md:px-4 border">0</td>
                          <td class="py-2 px-2 md:px-4 border">0</td>
