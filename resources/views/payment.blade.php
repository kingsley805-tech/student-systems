      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <ul class="logout-mode bg-white flex items-center justify-center space-x-6  md:ml-96">
            <li class="hover:bghoverbg rounded-md hover:text-txtC ml-4 md:ml-96 p-1 font-semibold text-g-600"><a href="#">
    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
      <div class="dash-content mt-2 py-5   bg-white shadow-md  ">
        <div class="title space-y-3">
            ...
            <span class="inner-name text bg-slate-50 font-extrabold text-textHover m-3    p-3 rounded-md">Payment</span>
        </div>
          ...
          <table class="table w-full">
              <tbody>
                  ...
                  <tr class="taj">
                      ...
                      <td class="p-2 text-textC font-normal border-2 ">{{$pays->Description}}</td>
                  </tr>
                  <tr class="taj">
                      <td class="p-2  border text-htext font-bold">Paying Amount</td>
                      <td class="p-2 text-textC font-normal border-2 ">{{$pays->payingAmount	}}</td>
                  </tr>
                  <tr class="taj">
                      <td class="p-2  border-2  text-htext font-bold">Payment Date</td>
                      <td class="p-2 text-textC font-normal border-2 ">{{$pays->PaymentDate}}</td>
                  </tr>
                
                  <tr class="taj">
                      <td class="p-2 border-2  text-htext font-bold">Receiver Role</td>
                      <td class="p-2">
                          <button class="unpaid bg-red-200 text-red-600 p-1 px-3 rounded-lg font-bold border-2 ">{{$pays->receiverRole}}</button>
                      </td>
                  </tr>
