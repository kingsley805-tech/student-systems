      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <a href="https://school.rapidentrepreneurs.com/" class="flex ml-2 md:mr-24">
            <img src="{{ URL::to('/') }}/assets/images/r-logo.png" class="bg-hoverText h-10 w-10 rounded-full " alt="">
            <span 
              class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap text-blue-400">Rapid <sub class="text-header md:ml-16 md:block hidden">system</sub></span>
          </a>
          <ul class="logout-mode bg-white flex items-center justify-center space-x-6  md:ml-96">
            ...
            <li class="hover:bg-hoverbg rounded-md hover:text-hoverText p-1 font-bold text-gray-600"><a href="./login">
