    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
      <div class="dash-content mt-2 py-5   bg-white shadow-md  ">
        <div class="title space-y-3">
            ...
            <span class="inner-name text bg-slate-50 font-extrabold text-textHover m-3 my-7  p-3 rounded-md">Notice Board</span>
        </div>
            ...
            <table class="table w-full">
                <tbody>
                  <tr class="taj">
                    ...
                    <td class="p-2 text-textC font-normal border-2 ">{{$no->	title}}</td>
                </tr>
                    <tr class="taj">
                        <td class="p-2 border-2 text-htext font-bold">Description</td>
                        <td class="p-2 text-textC font-normal border-2 ">{{$no->description}}</td>
                    </tr>
                    
                    <tr class="taj">
                        <td class="p-2  border-2  text-htext font-bold">Status</td>
                        <td class="p-2 text-textC font-normal border-2 ">{{$no->status}}</td>
                    </tr>
                    <tr class="taj">
                        <td class="p-2  border-2  text-htext font-bold">URL</td>
                        <td class="p-2 text-textC font-normal border-2 "><a href="{{$no->url}}"target='blank'class='text-white bg-blue-300 hover:bg-gray-400 p-2.5 rounded-md font-bold'>View</a></td>
                    </tr>
