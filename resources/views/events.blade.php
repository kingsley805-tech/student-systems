      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <ul class="logout-mode bg-white flex items-center justify-center space-x-6  md:ml-96">
            <li class="hover:b-overbg rounded-md hover:te-textC ml-4 md:ml-96 p-1 font-semibold textgray600"><a href="#">
    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
      <div class="dash-content mt-2 py-5   bg-white shadow-md  ">
        <div class="title space-y-3">
            ...
            <span class="inner-name text bg-slate-50 font-extrabold text-textHover m-3 my-10  p-3 rounded-md">Events</span>
        </div>
        
            <!--Events-->
<div class="event   mt-7">
            <div class="flex"><div class="w-10 h-10 bg-red-400 border-2 text-center  rounded-full border-red-400 font-black text-white text-2xl">!</div><div class="  text-gray-950 hover:text-gray-500 font-black mt-1 ml-2 text-xl md:2xl">Home Work Submission 06-10-2023</div></div>
        </div>
