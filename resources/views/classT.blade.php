      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <ul class="logout-mode bg-white flex items-center justify-center space-x-6  md:ml-96">
            <li class="hover:bg-overbg rounded-md hover:text-tetC ml-4 md:ml-96 p-1 font-semibold textgray-600"><a href="#">
    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
      <div class="dash-content mt-2 py-5   bg-white shadow-md  ">
        <div class="title space-y-3">
            ...
            <span class="inner-name text bg-slate-50 font-extrabold text-textHover m-3 my-10  p-3 rounded-md">Class Time Table</span>
        </div>
        
          <!--time table for class-->
          <div class="timet ">
          <div class=" bg-white flex flex-col items-center  justify-center m-auto pt-4">
           
              <br><span class=" font-bold text-xl text-textHover hover:text-gray-400 print"style="font-weight: bold; font-size: 1.25rem; ">
                <a href="" id="classtt">PRINT class Time Table</a></span></h1>
            <div class="w-full max-w-screen-md mx-auto p-4"id='classt'>
              <h1 class="font-semibold">Class Time table: {{$class}}</h1>
                <table class="w-full border-collapse border bg-white shadow-md border-gray-400"style="border: 1px solid #e2e8f0; background-color: #fff; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06); border-color: #e2e8f0;">
                    <thead>
                        <tr class="bg-gray-200"style="background-color: #edf2f7;">
                            <th class="border border-gray-300 p-2"style="border: 1px solid #e2e8f0; padding: 0.5rem;">Day</th>
                            <th class="border border-gray-300 p-2"style="border: 1px solid #e2e8f0; padding: 0.5rem;">Subject (Code)</th>
                            <th class="border border-gray-300 p-2"style="border: 1px solid #e2e8f0; padding: 0.5rem;">Time</th>
                            <th class="border border-gray-300 p-2"style="border: 1px solid #e2e8f0; padding: 0.5rem;">Room No.</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td class="border border-gray-300 p-2 font-bold"style="border: 1px solid #e2e8f0; padding: 0.5rem;">Monday</td>                           
                        </tr>

                        @foreach($resultData->Monday as $value)
                        <tr>
                            <td class="border border-gray-300 p-2"style="border: 1px solid #e2e8f0; padding: 0.5rem;"></td>
                            <td class="border border-gray-300 p-2"style="border: 1px solid #e2e8f0; padding: 0.5rem;">{{$value->subjectName}}</td>
                            <td class="border border-gray-300 p-2"style="border: 1px solid #e2e8f0; padding: 0.5rem;">{{$value->start_time}} - {{$value->end_time}}</td>
                            <td class="border border-gray-300 p-2"style="border: 1px solid #e2e8f0; padding: 0.5rem;">{{$value->room_number}}</td>
                        </tr>
                        @endforeach

                        <tr>
                          <td class="border border-gray-300 p-2 font-bold"style="border: 1px solid #e2e8f0; padding: 0.5rem;">Tuesday</td>                           
                      </tr>

                      @foreach($resultData->Tuesday as $value)
                      <tr>
                          <td class="border border-gray-300 p-2"style="border: 1px solid #e2e8f0; padding: 0.5rem;"></td>
                          <td class="border border-gray-300 p-2"style="border: 1px solid #e2e8f0; padding: 0.5rem;">{{$value->subjectName}}</td>
                          <td class="border border-gray-300 p-2"style="border: 1px solid #e2e8f0; padding: 0.5rem;">{{$value->start_time}} - {{$value->end_time}}</td>
                      ...
                      @endforeach
                          ...
                          <tr>
                            <td class="border border-gray-300 p-2 font-bold"style="border: 1px solid #e2e8f0; padding: 0.5rem;">Wednesday</td>                           
                        </tr>

                        @foreach($resultData->Wednesday as $value)
                        <tr>
                            <td class="border border-gray-300 p-2"style="border: 1px solid #e2e8f0; padding: 0.5rem;"></td>
                            <td class="border border-gray-300 p-2"style="border: 1px solid #e2e8f0; padding: 0.5rem;">{{$value->subjectName}}</td>
                            <td class="border border-gray-300 p-2"style="border: 1px solid #e2e8f0; padding: 0.5rem;">{{$value->start_time}} - {{$value->end_time}}</td>
                        ...
                        <tr>
                          <td class="border border-gray-300 p-2 font-bold"style="border: 1px solid #e2e8f0; padding: 0.5rem;">Thursday</td>                           
                      </tr>

                      @foreach($resultData->Thursday as $value)
                      <tr>
                          <td class="border border-gray-300 p-2"style="border: 1px solid #e2e8f0; padding: 0.5rem;"></td>
                          <td class="border border-gray-300 p-2"style="border: 1px solid #e2e8f0; padding: 0.5rem;">{{$value->subjectName}}</td>
                          <td class="border border-gray-300 p-2"style="border: 1px solid #e2e8f0; padding: 0.5rem;">{{$value->start_time}} - {{$value->end_time}}</td>
                      ...
                      <tr>
                        <td class="border border-gray-300 p-2 font-bold"style="border: 1px solid #e2e8f0; padding: 0.5rem;">Friday</td>                           
                    </tr>
                      @foreach($resultData->Friday as $value)
                      <tr>
                          <td class="border border-gray-300 p-2"style="border: 1px solid #e2e8f0; padding: 0.5rem;"></td>
                          <td class="border border-gray-300 p-2"style="border: 1px solid #e2e8f0; padding: 0.5rem;">{{$value->subjectName}}</td>
                          <td class="border border-gray-300 p-2"style="border: 1px solid #e2e8f0; padding: 0.5rem;">{{$value->start_time}} - {{$value->end_time}}</td>
            ...
            <div class="block  flex items-center justify-center"><span class="font-bold text-gray-700  ">Click here to downloading the Class Table</span>
            </div>
            ...
            <div class="print-download-exam flex items-center justify-center font-semibold text-xl hover:text-gray-400 text-header">
              <a href="#" id="loadButton">Class Table: Class Time Table........ </a>
            </div>
        </div></div>
       </div>
