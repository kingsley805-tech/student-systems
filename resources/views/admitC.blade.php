    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <ul class="logout-mode bg-white flex items-center justify-center space-x-6 m-a  md:ml-96">
            <li class=" ml-4 md:ml-96 p-1 font-semibold "><a href="#">
...
<path d="M1 13.4976L12.0209 1.64042C12.5617 1.05866 13.4383 1.05866 13.9791 1.64042L25 13.4976M3.76923 10.5182V23.9254C3.76923 24.7481 4.38914 25.415 5.15385 25.415H10.2308V18.9598C10.2308 18.137 10.8507 17.4701 11.6154 17.4701H14.3846C15.1493 17.4701 15.7692 18.137 15.7692 18.9598V25.415H20.8462C21.6109 25.415 22.2308 24.7481 22.2308 23.9254V10.5182M8.38462 25.415H18.5385" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  ...
  <div class="p-4 sm:ml-64">
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
      <div class="dash-content mt-2 py-5   bg-white shadow-md  ">
        <div class="title space-y-3">
            ...
            <span class="inner-name text bg-slate-50 font-extrabold text-textHover m-3 my-10  p-3 rounded-md">Admit Card</span>
        </div>
        <p><button class="print-admit font-bold text-2xl text-hoverText hover:text-blue-200 my-6 ml-3"id='printer-admit'>PRINT ADMIT CARD</button></p>
       
        <!--Admitt card-->
        <div class="admitC " id="admitts">

            <div class="admit-card  bg-white flex flex-col items-center justify-center m-auto pt-4" style="background-color: #fff; display: flex; flex-direction: column; align-items: center; justify-content: center; margin: auto; padding-top: 1rem;">
                <div class="container mx-auto p-4" style="margin-left: auto;
                margin-right: auto;padding: 1rem/* 16px */;">
                    <div class="bg-white p-6 border border-gray-300 rounded-lg shadow-md"style='border: 1px solid #ccc; border-radius: 0.375rem; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);  background-color: rgb(255 255 255 / var(--tw-bg-opacity));  padding: 1.5rem/* 24px */;'>
                      <h1 class="text-2xl font-semibold mb-4"style='font-size: 1.5rem; font-weight: 600; margin-bottom: 1rem;--tw-text-opacity: 1;
                      color: rgb(96 165 250 / var(--tw-text-opacity));
                  '>Admit Card: End Of Third Semester Examination (18-09-2023 - 18-10-2023)</h1>
                  
                      <div class="mb-4"style=' margin-bottom: 1rem/* 16px */;'>
                        <p><strong>Class:</strong> JHS 3</p>
                      </div>
                      ...
                      <hr class="my-4"style=' margin-bottom: 1rem/* 16px */;'>
                  
                      <div class="mb-4"style=' margin-bottom: 1rem/* 16px */;'>
                        <p><strong>Rapid School</strong></p>
                        <p>Phone: 0554440059 | Email: school@rapidentrepreneurs.com</p>
                        <p>Address: South Suntreso, Kumasi</p>
                      </div>
                  
                      <hr class="my-4"style=' margin-bottom: 1rem/* 16px */;'>
                  
                      <h2 class="text-xl font-semibold mb-4"style="font-size: 1.25rem; font-weight: 600; margin-bottom: 1rem;">STUDENT ADMIT CARD</h2>
                  <div class="flex flex-col items-center justify-center md:flex-row space-y-40 md:space-x-40"id='textFlex'style="">
                      <div class="mb-4"style=' margin-bottom: 1rem/* 16px */;'>
                        <p><strong>Student Name:</strong>{{ $add->FirstName}} {{ $add->LastName}}</p>
                        <p><strong>Admission Date:</strong>{{ $add->AdmissionDate}}</p>
                        <p><strong>Index Number:</strong>{{ $add->IndexNumber}}</p>
                        <p><strong>Class ID:</strong>{{ $add->classroom_id}}</p>
                        <p><strong>Identity Number:</strong>{{ $add->IdentityNumber }}</p>
                        <p><strong>Phone:</strong>{{ $add->StudentNumber}}</p>
                      </div>
                      <div id="uploaded-image-container" class="imageCont mt-4"style=' margin-top: 1rem/* 16px */;'>
                        <!-- Display the uploaded image here -->
                        <img id="uploaded-image" src="./assets/images/user-hands-svgrepo-com.svg" alt="Uploaded Image"  class="rounded-full w-40 h-40" style=" border-radius: 9999px; width: 10rem/* 160px */;  height: 10rem/* 160px */;">
                      </div>
                    </div>
                  </div>
    ...
    <div class="p-6 bg-white rounded-lg shadow-md"id='bothE' style="padding: 1.5rem; background-color: #fff; border-radius: 0.375rem; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
      <!-- Upload Form -->
      <form id="image-upload-form" enctype="multipart/form-data">
        <div class="mb-4"style='  margin-bottom: 1rem/* 16px */;'>
          <label for="image" class="text-gray-600 font-semibold">Select an image:</label>
          <input type="file" name="image" id="image" class="block w-full px-4 py-2 mt-2 text-gray-800 border rounded-lg focus:outline-none focus:border-blue-500" onchange="displayImage()">
        </div>
        <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline-blue">
          Upload
        </button>
      </form>
      </div>
      
      <!-- Uploaded Image Display Container -->
      <div class="p-6 bg-white rounded-lg shadow-md"id='uploadC'>
        <h2 class="text-gray-800 text-lg font-semibold"id='upload'>Uploaded Image</h2>
